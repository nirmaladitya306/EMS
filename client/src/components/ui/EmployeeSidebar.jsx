...
const styles = `
  ...
  .em-sidebar-inner { font-family: 'DM Sans', sans-serif; display: flex; flex-direction: column; height: 100%; background: #ffffff; border-right: 1px solid rgba(0,0,0,0.06); }
  .em-sidebar-header { padding: 18px 14px 14px; border-bottom: 1px solid rgba(0,0,0,0.06); flex-shrink: 0; }
  ...
  .em-sidebar-logo-text { font-size: 11px; font-weight: 500; color: rgba(0,0,0,0.35); letter-spacing: 0.06em; text-transform: uppercase; }
  ...
  .em-nav-section-label { font-size: 9px; letter-spacing: 0.12em; text-transform: uppercase; color: rgba(0,0,0,0.25); font-weight: 600; padding: 10px 10px 4px; }
  ...
  .em-nav-label { font-size: 12.5px; color: rgba(0,0,0,0.6); white-space: nowrap; }
  .em-sidebar-footer { padding: 10px 14px 14px; border-top: 1px solid rgba(0,0,0,0.05); flex-shrink: 0; }
        ...
        <SidebarContent>
          <div className="em-sidebar-inner">
            ...
            <div className="em-sidebar-footer">
              <p className="em-footer-badge">Enterprise Workforce · Employee</p>
            </div>
          </div>
        </SidebarContent>
      </Sidebar>
