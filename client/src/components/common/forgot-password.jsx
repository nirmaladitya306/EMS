...
const styles = `
  ...
  .auth-badge {
    font-size: 11px; font-weight: 500; color: rgba(99,102,241,0.9);
  ...
  .auth-eyebrow {
    ...
    color: rgba(99,102,241,0.8); font-weight: 500;
