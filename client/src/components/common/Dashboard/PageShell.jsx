const shellStyles = `
  ...
  .pg-subtitle { font-size: 12px; color: rgba(0,0,0,0.38); font-weight: 300; margin: 0; transition: color 0.2s; }
  ...
  .pg-search {
    ...
    outline: none; transition: border-color 0.2s, box-shadow 0.2s, background 0.2s, color 0.2s; min-width: 200px;
  }
  ...
  .pg-th { font-size: 10px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: rgba(0,0,0,0.3); transition: color 0.2s; }
  .pg-table-row {
    display: grid; padding: 11px 16px;
    border-bottom: 1px solid rgba(0,0,0,0.05);
    align-items: center; transition: background 0.12s, border-color 0.2s;
  ...
  .pg-td-name  { font-weight: 500; color: #0f172a; transition: color 0.2s; }
  .pg-td-sub   { font-size: 11px; color: rgba(0,0,0,0.35); margin-top: 1px; transition: color 0.2s; }
  .pg-td-muted { color: rgba(0,0,0,0.4); font-size: 12px; transition: color 0.2s; }
  ...
  .pg-empty-title { font-size: 14px; font-weight: 500; color: rgba(0,0,0,0.45); transition: color 0.2s; }
  .pg-empty-sub   { font-size: 12px; color: rgba(0,0,0,0.28); max-width: 280px; line-height: 1.6; transition: color 0.2s; }
  ...
  .pg-pagination-info { font-size: 12px; color: rgba(0,0,0,0.38); transition: color 0.2s; }
  .pg-page-btn {
  ...
  /* ── Tabs ── */
  .pg-tabs { display: flex; border-bottom: 1px solid rgba(0,0,0,0.07); flex-shrink: 0; transition: border-color 0.2s; }
  .pg-tab {
  ...
  .pg-modal-title { font-family: 'DM Serif Display', serif; font-size: 1.3rem; color: #0f172a; letter-spacing: -0.02em; margin: 0; transition: color 0.2s; }
  .pg-modal-actions { display: flex; justify-content: flex-end; gap: 10px; padding-top: 4px; border-top: 1px solid rgba(0,0,0,0.06); transition: border-color 0.2s; }

  /* ── Form ── */
  .pg-field { display: flex; flex-direction: column; gap: 5px; }
  .pg-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.09em; color: rgba(0,0,0,0.4); transition: color 0.2s; }
  .pg-input, .pg-textarea {
    width: 100%; padding: 9px 13px; border: 1px solid rgba(0,0,0,0.12);
    background: #fff; border-radius: 10px;
    font-family: 'DM Sans', sans-serif; font-size: 13px; color: #0f172a;
    outline: none; transition: border-color 0.2s, box-shadow 0.2s, background 0.2s, color 0.2s; box-sizing: border-box;
  }
  ...
  .pg-divider { height: 1px; background: rgba(0,0,0,0.06); flex-shrink: 0; transition: background 0.2s; }
  ...
  .pg-root { animation: fadeUp 0.35s ease both; }
`
