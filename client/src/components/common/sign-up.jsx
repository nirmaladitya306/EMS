...
const styles = `
  ...
  .auth-root {
    ...
    font-family: 'DM Sans', sans-serif; overflow-x: hidden; position: relative;
  }
  ...
  .signup-header { display: flex; flex-direction: column; gap: 6px; }
  ...
  .signup-section-label {
    ...
    color: rgba(0,0,0,0.3); font-weight: 600; margin-bottom: 16px;
  ...
  @media (max-width: 640px) {
    ...
    .signup-card { padding: 28px 20px; border-radius: 18px; }
...
export const SignUP = ({ handlesignupform, handlesubmitform, stateformdata, errorpopup }) => {
    ...
    const field = (id, label, type = 'text', placeholder = '') => (
        <div className="auth-field">
            <label className={lc} htmlFor={id}>{label}</label>
            <input className={fc} id={id} name={id} type={type} required
                    ...
                    <div className="signup-card">
                        ...
                        <div>
                            ...
                            <div className="signup-grid">
                                ...
                                {field('contactnumber', 'Contact number', 'number', '+1 555 000 0000')}
                                {field('textpassword', 'Password', 'password', 'At least 8 characters')}
                                {field('password', 'Confirm password', 'password', 'Repeat your password')}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="signup-grid">
                                {field('name',             'Organisation name',        'text', 'Acme Corp')}
                                {field('description',      'Description',              'text', 'What your organisation does')}
                                {field('OrganizationURL',  'Organisation URL',         'text', 'acmecorp.com')}
                                {field('OrganizationMail', 'Organisation email',       'email', 'hr@acmecorp.com')}
                            </div>
                        </div>
                        ...
                        <div className="signup-actions">
                            <button className="auth-submit-btn" onClick={handlesubmitform}>
                                Create account →
                            </button>
