...
const styles = `
  ...
  .auth-root {
    min-height: 100vh; background-color: var(--ems-bg, #ffffff);
    ...
    background-size: 60px 60px; display: flex; flex-direction: column;
...
export const Reset_Password = ({ handlepasswordsubmit, handlepasswordform, passworderror, targetstate }) => {
    return (
        <>
            ...
            {passworderror && <ErrorPopup error="Passwords do not match. Please try again." />}
                ...
                <div className="auth-body">
                    <div className="auth-card">
                        ...
                        <div>
                            ...
                            <p className="auth-subtitle">Choose a strong password. You'll use it to sign in from now on.</p>
                        </div>
                        ...
                        <form className="auth-form">
                            <div className="auth-field">
                                ...
                                <input className="auth-input" id="password" name="password" type="password"
                                    required onChange={handlepasswordform} placeholder="At least 8 characters" />
                            </div>
                            <div className="auth-field">
                                <label className="auth-label" htmlFor="repeatpassword">Confirm new password</label>
                                <input className="auth-input" id="repeatpassword" name="repeatpassword" type="password"
                                    required onChange={handlepasswordform} placeholder="Repeat your password" />
                            </div>
                            <button type="submit" className="auth-submit-btn" onClick={handlepasswordsubmit}>
                                Set new password →
                            </button>
                        </form>
                        <p className="auth-footer-note">Make sure it's at least 8 characters</p>
                    </div>
                </div>
            </div>
        </>
