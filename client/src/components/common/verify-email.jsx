...
const styles = `
  ...
  .auth-eyebrow::before, .auth-eyebrow::after { content: ''; height: 1px; width: 24px; background: rgba(99,102,241,0.4); }
            ...
            <div className="auth-root">
                ...
                <div className="auth-body">
                    <div className="auth-card">
                        ...
                        <button className="auth-submit-btn" onClick={handleOTPsubmit}>Verify email →</button>
